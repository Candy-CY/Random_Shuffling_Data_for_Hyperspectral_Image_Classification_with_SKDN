...
# @Time        : 2023/10/16 16:15
# @Filename    : SKDN_TD_KSC_SSTFF.py
# @Author      : Candy
...
def loadData():
    ## 读入数据
    data = sio.loadmat('/kaggle/input/hybridsn/data/KSC.mat')['KSC']
    labels = sio.loadmat('/kaggle/input/hybridsn/data/KSC_gt.mat')['KSC_gt']
    return data, labels
...
if __name__ == '__main__':
    ...
    file_name = "./"+str(time)+"_0.1_SSFTT_classification_0.2_KSC_epochs_100_report.txt"
