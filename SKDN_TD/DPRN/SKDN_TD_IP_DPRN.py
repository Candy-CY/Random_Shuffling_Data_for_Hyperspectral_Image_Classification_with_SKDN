...
# @Filename    : SKDN_TR_IP_DPRN.py.py
# @Author      : Candy
...
def loadData(name,Random,num_components=None):
    ...
    if name == 'IP':
        ...
        if Random == 1:
            data1 = sio.loadmat(os.path.join(data_path,'Indian_pines_corrected.mat'))['indian_pines_corrected']
            labels1 = sio.loadmat(os.path.join(data_path,'Indian_pines_gt.mat'))['indian_pines_gt']
...
def main():
    ...
    #parser.add_argument('--Random',default=0,type=int,help='Random Shuffle')
    ...
    file_name = "./"+str(time1)+"_1_DPRN_classification_0.2_IP_epochs_200_report.txt"
