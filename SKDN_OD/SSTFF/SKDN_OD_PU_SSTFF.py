...
# @Time        : 2023/10/16 16:25
# @Filename    : SKDN_OD_PU_SSTFF.py
# @Author      : Candy
...
def loadData():
    # 读入数据
    data = sio.loadmat('/kaggle/input/hybridsn/data/paviaU.mat')['paviaU']
    labels = sio.loadmat('/kaggle/input/hybridsn/data/paviaU_gt.mat')['paviaU_gt']
    return data, labels
...
if __name__ == '__main__':
    ...
    file_name = "./"+str(time)+"_0.1_SSFTT_classification_0.1_PU_epochs_100_report.txt"
